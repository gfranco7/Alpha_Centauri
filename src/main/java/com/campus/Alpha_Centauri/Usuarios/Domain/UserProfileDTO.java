...
public class UserProfileDTO {
    ...
    public UserProfileDTO(Long id, String name, String lastname, String username, String photo, String bio, List<Long> publications, List<Long> followersIds, List<Long> followingIds) {
        this.id = id;
        this.name = name;
